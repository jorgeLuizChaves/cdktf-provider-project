// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/peering
...
export interface DataConfluentPeeringConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/peering#display_name DataConfluentPeering#display_name}
  */
  readonly displayName?: string;
  /**
  * The ID of the Peering, for example, `pla-abc123`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/peering#id DataConfluentPeering#id}
  *
  ...
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/peering#environment DataConfluentPeering#environment}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/peering confluent_peering}
*/
export class DataConfluentPeering extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentPeering that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/peering#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/peering confluent_peering} Data Source
  *
  * @param scope The scope in which to define this construct
