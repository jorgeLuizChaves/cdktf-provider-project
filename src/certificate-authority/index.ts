// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/certificate_authority
...
export interface CertificateAuthorityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/certificate_authority#certificate_chain CertificateAuthority#certificate_chain}
  */
  readonly certificateChain: string;
  /**
  * The name of the certificate file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/certificate_authority#certificate_chain_filename CertificateAuthority#certificate_chain_filename}
  */
  readonly certificateChainFilename: string;
  /**
  * A base64 encoded string containing the CRL for this certificate authority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/certificate_authority#crl_chain CertificateAuthority#crl_chain}
  */
  readonly crlChain?: string;
  /**
  * The url from which to fetch the CRL for the certificate authority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/certificate_authority#crl_url CertificateAuthority#crl_url}
  */
  readonly crlUrl?: string;
  /**
  * A description of the Certificate Authority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/certificate_authority#description CertificateAuthority#description}
  */
  readonly description: string;
  /**
  * A name for the Certificate Authority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/certificate_authority#display_name CertificateAuthority#display_name}
  */
  readonly displayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/certificate_authority#id CertificateAuthority#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/certificate_authority confluent_certificate_authority}
*/
export class CertificateAuthority extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertificateAuthority that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/certificate_authority#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/certificate_authority confluent_certificate_authority} Resource
  *
  * @param scope The scope in which to define this construct
