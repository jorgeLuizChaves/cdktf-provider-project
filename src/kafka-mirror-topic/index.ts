// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic
...
export interface KafkaMirrorTopicConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#id KafkaMirrorTopic#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#mirror_topic_name KafkaMirrorTopic#mirror_topic_name}
  */
  readonly mirrorTopicName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#status KafkaMirrorTopic#status}
  */
  readonly status?: string;
  /**
  * cluster_link block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#cluster_link KafkaMirrorTopic#cluster_link}
  */
  readonly clusterLink: KafkaMirrorTopicClusterLink;
  /**
  * kafka_cluster block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#kafka_cluster KafkaMirrorTopic#kafka_cluster}
  */
  readonly kafkaCluster: KafkaMirrorTopicKafkaCluster;
  /**
  * source_kafka_topic block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#source_kafka_topic KafkaMirrorTopic#source_kafka_topic}
  */
...
export interface KafkaMirrorTopicClusterLink {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#link_name KafkaMirrorTopic#link_name}
  */
...
export interface KafkaMirrorTopicKafkaClusterCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#key KafkaMirrorTopic#key}
  */
  readonly key: string;
  /**
  * The Kafka API Secret for your Confluent Cloud cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#secret KafkaMirrorTopic#secret}
  */
...
export interface KafkaMirrorTopicKafkaCluster {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#rest_endpoint KafkaMirrorTopic#rest_endpoint}
  */
  readonly restEndpoint?: string;
  /**
  * credentials block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#credentials KafkaMirrorTopic#credentials}
  */
...
export interface KafkaMirrorTopicSourceKafkaTopic {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#topic_name KafkaMirrorTopic#topic_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic confluent_kafka_mirror_topic}
*/
export class KafkaMirrorTopic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KafkaMirrorTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/kafka_mirror_topic confluent_kafka_mirror_topic} Resource
  *
  * @param scope The scope in which to define this construct
