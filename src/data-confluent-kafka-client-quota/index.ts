// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/kafka_client_quota
...
export interface DataConfluentKafkaClientQuotaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/kafka_client_quota#id DataConfluentKafkaClientQuota#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/kafka_client_quota confluent_kafka_client_quota}
*/
export class DataConfluentKafkaClientQuota extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentKafkaClientQuota that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/kafka_client_quota#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/kafka_client_quota confluent_kafka_client_quota} Data Source
  *
  * @param scope The scope in which to define this construct
