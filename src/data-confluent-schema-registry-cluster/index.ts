// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schema_registry_cluster
...
export interface DataConfluentSchemaRegistryClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schema_registry_cluster#display_name DataConfluentSchemaRegistryCluster#display_name}
  */
  readonly displayName?: string;
  /**
  * The ID of the Schema Registry cluster, for example, `lsrc-755ogo`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schema_registry_cluster#id DataConfluentSchemaRegistryCluster#id}
  *
  ...
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schema_registry_cluster#environment DataConfluentSchemaRegistryCluster#environment}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schema_registry_cluster confluent_schema_registry_cluster}
*/
export class DataConfluentSchemaRegistryCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentSchemaRegistryCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schema_registry_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schema_registry_cluster confluent_schema_registry_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
