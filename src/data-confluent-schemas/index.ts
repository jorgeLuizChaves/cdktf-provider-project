// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas
...
export interface DataConfluentSchemasConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas#id DataConfluentSchemas#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas#rest_endpoint DataConfluentSchemas#rest_endpoint}
  */
  readonly restEndpoint?: string;
  /**
  * credentials block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas#credentials DataConfluentSchemas#credentials}
  */
  readonly credentials?: DataConfluentSchemasCredentials;
  /**
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas#filter DataConfluentSchemas#filter}
  */
  readonly filter?: DataConfluentSchemasFilter;
  /**
  * schema_registry_cluster block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas#schema_registry_cluster DataConfluentSchemas#schema_registry_cluster}
  */
...
export interface DataConfluentSchemasCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas#key DataConfluentSchemas#key}
  */
  readonly key: string;
  /**
  * The Cluster API Secret for your Confluent Cloud cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas#secret DataConfluentSchemas#secret}
  */
...
export interface DataConfluentSchemasFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas#deleted DataConfluentSchemas#deleted}
  */
  readonly deleted?: boolean | cdktf.IResolvable;
  /**
  * Whether to return soft deleted schemas. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas#latest_only DataConfluentSchemas#latest_only}
  */
  readonly latestOnly?: boolean | cdktf.IResolvable;
  /**
  * The prefix of the Schema Registry Subject.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas#subject_prefix DataConfluentSchemas#subject_prefix}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas confluent_schemas}
*/
export class DataConfluentSchemas extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentSchemas that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/schemas confluent_schemas} Data Source
  *
  * @param scope The scope in which to define this construct
