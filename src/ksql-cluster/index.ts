// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster
...
export interface KsqlClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster#csu KsqlCluster#csu}
  */
  readonly csu: number;
  /**
  * The name of the ksqlDB cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster#display_name KsqlCluster#display_name}
  */
  readonly displayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster#id KsqlCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster#use_detailed_processing_log KsqlCluster#use_detailed_processing_log}
  */
  readonly useDetailedProcessingLog?: boolean | cdktf.IResolvable;
  /**
  * credential_identity block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster#credential_identity KsqlCluster#credential_identity}
  */
  readonly credentialIdentity: KsqlClusterCredentialIdentity;
  /**
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster#environment KsqlCluster#environment}
  */
  readonly environment: KsqlClusterEnvironment;
  /**
  * kafka_cluster block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster#kafka_cluster KsqlCluster#kafka_cluster}
  */
  readonly kafkaCluster: KsqlClusterKafkaCluster;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster#timeouts KsqlCluster#timeouts}
  */
...
export interface KsqlClusterTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster#create KsqlCluster#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster confluent_ksql_cluster}
*/
export class KsqlCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KsqlCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/ksql_cluster confluent_ksql_cluster} Resource
  *
  * @param scope The scope in which to define this construct
