// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin
...
export interface CustomConnectorPluginConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin#cloud CustomConnectorPlugin#cloud}
  */
  readonly cloud?: string;
  /**
  * Java class or alias for connector. You can get connector class from connector documentation provided by developer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin#connector_class CustomConnectorPlugin#connector_class}
  */
  readonly connectorClass: string;
  /**
  * Custom Connector type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin#connector_type CustomConnectorPlugin#connector_type}
  */
  readonly connectorType: string;
  /**
  * A free-form description of the Custom Connector Plugin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin#description CustomConnectorPlugin#description}
  */
  readonly description?: string;
  /**
  * A human-readable name for the Custom Connector Plugin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin#display_name CustomConnectorPlugin#display_name}
  */
  readonly displayName: string;
  /**
  * A documentation link of the Custom Connector Plugin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin#documentation_link CustomConnectorPlugin#documentation_link}
  */
  readonly documentationLink?: string;
  /**
  * The path to the file that will be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin#filename CustomConnectorPlugin#filename}
  */
  readonly filename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin#id CustomConnectorPlugin#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin#sensitive_config_properties CustomConnectorPlugin#sensitive_config_properties}
  */
  readonly sensitiveConfigProperties?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin confluent_custom_connector_plugin}
*/
export class CustomConnectorPlugin extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomConnectorPlugin that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/custom_connector_plugin confluent_custom_connector_plugin} Resource
  *
  * @param scope The scope in which to define this construct
