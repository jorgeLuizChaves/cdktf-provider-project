// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service
...
export interface NetworkLinkServiceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service#description NetworkLinkService#description}
  */
  readonly description?: string;
  /**
  * The display name of the Network Link Service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service#display_name NetworkLinkService#display_name}
  */
  readonly displayName?: string;
  /**
  * accept block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service#accept NetworkLinkService#accept}
  */
  readonly accept?: NetworkLinkServiceAccept;
  /**
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service#environment NetworkLinkService#environment}
  */
  readonly environment: NetworkLinkServiceEnvironment;
  /**
  * network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service#network NetworkLinkService#network}
  */
  readonly network: NetworkLinkServiceNetwork;
}
export interface NetworkLinkServiceAccept {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service#environments NetworkLinkService#environments}
  */
  readonly environments?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service#networks NetworkLinkService#networks}
  */
...
export interface NetworkLinkServiceEnvironment {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service#id NetworkLinkService#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service confluent_network_link_service}
*/
export class NetworkLinkService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkLinkService that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/resources/network_link_service confluent_network_link_service} Resource
  *
  * @param scope The scope in which to define this construct
