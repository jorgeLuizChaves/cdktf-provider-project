// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/flink_compute_pool
...
export interface DataConfluentFlinkComputePoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/flink_compute_pool#display_name DataConfluentFlinkComputePool#display_name}
  */
  readonly displayName?: string;
  /**
  * The ID of the Compute Pool, for example, `lfcp-abc123`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/flink_compute_pool#id DataConfluentFlinkComputePool#id}
  *
  ...
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/flink_compute_pool#environment DataConfluentFlinkComputePool#environment}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/flink_compute_pool confluent_flink_compute_pool}
*/
export class DataConfluentFlinkComputePool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentFlinkComputePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/flink_compute_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/flink_compute_pool confluent_flink_compute_pool} Data Source
  *
  * @param scope The scope in which to define this construct
