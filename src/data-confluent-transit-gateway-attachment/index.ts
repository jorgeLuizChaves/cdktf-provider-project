// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/transit_gateway_attachment
...
export interface DataConfluentTransitGatewayAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/transit_gateway_attachment#display_name DataConfluentTransitGatewayAttachment#display_name}
  */
  readonly displayName?: string;
  /**
  * The ID of the TransitGatewayAttachment, for example, `pla-abc123`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/transit_gateway_attachment#id DataConfluentTransitGatewayAttachment#id}
  *
  ...
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/transit_gateway_attachment#environment DataConfluentTransitGatewayAttachment#environment}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/transit_gateway_attachment confluent_transit_gateway_attachment}
*/
export class DataConfluentTransitGatewayAttachment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentTransitGatewayAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/transit_gateway_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/transit_gateway_attachment confluent_transit_gateway_attachment} Data Source
  *
  * @param scope The scope in which to define this construct
