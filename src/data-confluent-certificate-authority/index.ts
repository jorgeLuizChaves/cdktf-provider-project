// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_authority
...
export interface DataConfluentCertificateAuthorityConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_authority#crl_source DataConfluentCertificateAuthority#crl_source}
  */
  readonly crlSource?: string;
  /**
  * The timestamp for when CRL was last updated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_authority#crl_updated_at DataConfluentCertificateAuthority#crl_updated_at}
  */
  readonly crlUpdatedAt?: string;
  /**
  * The url from which to fetch the CRL for the certificate authority if crl_source is URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_authority#crl_url DataConfluentCertificateAuthority#crl_url}
  */
  readonly crlUrl?: string;
  /**
  * The ID of the Certificate Authority, for example, `op-abc123`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_authority#id DataConfluentCertificateAuthority#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_authority confluent_certificate_authority}
*/
export class DataConfluentCertificateAuthority extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentCertificateAuthority that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_authority#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_authority confluent_certificate_authority} Data Source
  *
  * @param scope The scope in which to define this construct
