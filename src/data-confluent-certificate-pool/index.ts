// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_pool
...
export interface DataConfluentCertificatePoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_pool#id DataConfluentCertificatePool#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_pool#certificate_authority DataConfluentCertificatePool#certificate_authority}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_pool confluent_certificate_pool}
*/
export class DataConfluentCertificatePool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentCertificatePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/certificate_pool confluent_certificate_pool} Data Source
  *
  * @param scope The scope in which to define this construct
