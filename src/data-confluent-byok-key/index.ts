// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/byok_key
...
export interface DataConfluentByokKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/byok_key#id DataConfluentByokKey#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/byok_key confluent_byok_key}
*/
export class DataConfluentByokKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentByokKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/byok_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/byok_key confluent_byok_key} Data Source
  *
  * @param scope The scope in which to define this construct
