// https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/provider_integration
...
export interface DataConfluentProviderIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/provider_integration#display_name DataConfluentProviderIntegration#display_name}
  */
  readonly displayName?: string;
  /**
  * The ID for provider integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/provider_integration#id DataConfluentProviderIntegration#id}
  *
  ...
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/provider_integration#environment DataConfluentProviderIntegration#environment}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/provider_integration confluent_provider_integration}
*/
export class DataConfluentProviderIntegration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentProviderIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/provider_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.9.0/docs/data-sources/provider_integration confluent_provider_integration} Data Source
  *
  * @param scope The scope in which to define this construct
